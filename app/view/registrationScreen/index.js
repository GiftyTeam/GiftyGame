...
// import {signInWithPhoneNumber} from './firebasePhoneAuth/firebasePhoneAuth';
import auth from '@react-native-firebase/auth';
import {connect} from 'react-redux';
import {setConfirmCode} from '../waitingCodeScreen/redux/codeValidation';

const RegistrationScreen = connect(null, {setConfirmCode})(
  ({navigation, setConfirmCode}) => {
