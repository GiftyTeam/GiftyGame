...
const DropDown = ()=> {
 ...
 const modalVisible = useSelector(state => state.mainScreenReducer.modalVisible)
  ...
  return (
     ...
     onRequestClose={() => dispatch(ModalVisible(false))}>
      <TouchableWithoutFeedback  onPress={() => {dispatch(ModalVisible(false))}}>
      ...
      <View style={modalStyle.container}>
       ...
       style={modalStyle.buttonStyle}>
         <Text style={modalStyle.buttonText}>{appLocalization.howToPlay}</Text>
       </TouchableOpacity>
